	...
	<tr>
		<td colspan="5" align="center">
			<c:if test="${nowGrp >= 2}">
				...
				<a href="${pageContext.request.contextPath}/qna/list.do?&nowPage=${BnowPage }&sch_type=${sch_type }&sch_value=${sch_value}">이전</a>
				</span>
			</c:if> 
			...
			<c:forEach var="i" begin="${startPage }" end="${endPage }">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<span class='span_box_1'> 
						<a href="${pageContext.request.contextPath}/qna/list.do?nowPage=${i}&sch_type=${sch_type }&sch_value=${sch_value}">${i}</a>
						</span>
					</c:otherwise>
				</c:choose>
			...
			<c:if test="${nowGrp < totalGrp}">
				<span class='span_box_1'> 
				<a href="${pageContext.request.contextPath}/qna/list.do?nowPage=${NnowPage }&sch_type=${sch_type }&sch_value=${sch_value}">다음</a>
				</span>
			</c:if></td>
	</tr>
</Div>
