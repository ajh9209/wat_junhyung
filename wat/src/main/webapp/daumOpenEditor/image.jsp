...
<head>
	...
	<!-- 다음오픈에디터 라이브러리 -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/daumOpenEditor/css/popup.css" type="text/css" charset="utf-8"/>
	<script src="${pageContext.request.contextPath}/daumOpenEditor/js/popup.js" type="text/javascript" charset="utf-8"></script>
 
	<!-- jQuery 라이브러리 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/daumOpenEditor/js/jquery.js"></script>
	<!-- jquery.form.js - ajaxSubmit() 사용 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/daumOpenEditor/js/jquery.form.js"></script>
