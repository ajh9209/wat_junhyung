...
<!-- 다음오픈에디터 라이브러리 -->
<link rel="stylesheet"
   href="${pageContext.request.contextPath}/daumOpenEditor/css/popup.css"
   type="text/css" charset="utf-8" />
<script
   src="${pageContext.request.contextPath}/daumOpenEditor/js/popup.js"
   type="text/javascript" charset="utf-8"></script>

<!-- jQuery 라이브러리 -->
<script type="text/javascript"
   src="${pageContext.request.contextPath}/daumOpenEditor/js/jquery.js"></script>
<!-- jquery.form.js - ajaxSubmit() 사용 -->
<script type="text/javascript"
   src="${pageContext.request.contextPath}/daumOpenEditor/js/jquery.form.js"></script>
...
<script>
   ...
   function done(fileInfo) { //fileInfo는 Ajax 요청 후 리턴하는 JSON형태의 데이터를 담을 객체
      ...
      var _mockdata = {
         'attachurl' : "${pageContext.request.contextPath}/editorFileDown.do?filePath="
               + fileInfo.attachurl
               + "&fileRealName="
               + fileInfo.filename
                        ...
                        .on(
                              ...
                              function() {
                                 ...
                                 form
                                       .ajaxSubmit({
                                          type : 'POST',
                                          url : '${pageContext.request.contextPath}/daumOpenEditor/singleUploadFileAjax',
...
<body onload="initUploader();">
   ...
   <div class="wrapper">
         ...
         <dl class="alert">
            ...
            <dd>
               <form id="daumOpenEditorForm" enctype="multipart/form-data"
                  ...
                  <!-- 파일첨부 -->
                  <div class="file">
                     <input type="text" class="file-text"> <label
      ...
      <div class="footer">
         <ul>
            <li class="submit"><a href="#" title="등록" class="btnlink">등록</a>
            </li>
