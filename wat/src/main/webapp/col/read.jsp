...
<div class='bottom'>
	<input type='button' value='수정'
		onclick="location.href='./update.do?b_no=${dto.b_no }'"> <input
		type='button' value='목록' onclick="location.href='./list.do'">
	<input type='button' value='삭제'
		onclick="location.href='./delete.do?b_no=${dto.b_no }'"> <input
		type='button' value='추천' onclick="reCommend(${dto.b_no })">
</div>
...
<FORM name='replyfrm' method='POST' action='./replyCreate.do'>
	<table class='table'>
		<tr>
			...
			<td><input type="hidden" name='b_no' value=${dto.b_no }>
			</td>
		</tr>
